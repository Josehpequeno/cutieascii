...
rpm-spec: rpm-dirs
	...
	@echo "URL: https://github.com/Josehpequeno/cutieascii" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	...
	@echo "mkdir -p %{buildroot}/usr/share/cutieascii" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "install -m 755 build/cutieascii %{buildroot}/usr/bin/cutieascii" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "cp -r kaoscii %{buildroot}/usr/share/cutieascii/" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "%files" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "/usr/bin/cutieascii" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "/usr/share/cutieascii/*" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
	@echo "" >> $(RPM_SPEC_DIR)/$(RPM_NAME).spec
